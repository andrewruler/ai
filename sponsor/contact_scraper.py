...
class ContactScraper:
    ...
    def extract_contact_info(self, soup: BeautifulSoup, url: str) -> Dict[str, str]:
        ...
        for link in soup.find_all('a', href=True):
            ...
            contact_keywords = ['contact', 'about', 'support', 'help', 'reach', 'get in touch']
            if any(keyword in link_text for keyword in contact_keywords):
                full_url = urljoin(url, href)
                contact_links.append(full_url)
        
        contact_info['contact_links'] = list(set(contact_links))
    ...
    def export_results(self, filename: str = 'contact_results.csv'):
    ...
    def export_json(self, filename: str = 'contact_results.json'):
...
Oplaza Sushi	Not available	https://oplaza.ca"""
    ...
    print("Starting contact information scraping...")
    ...
    # Export results
    scraper.export_results('contact_results.csv')
    scraper.export_json('contact_results.json')
    ...
    print("Check contact_results.csv and contact_results.json for detailed results")
